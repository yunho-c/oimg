// Wavy Grayscale Background (No Anti-Aliasing)
// Replicates a smooth overlapping sine-wave animation with hard edges
...
void mainImage( out vec4 fragColor, in vec2 fragCoord )
{
    ...
    // Hard edge using step()
    col = mix(col, col1, step(uv.y, h1));
